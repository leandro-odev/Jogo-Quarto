...
from components.ia import jogada
...
def jogar():
    ...
    while True:
        if jogador == 1:
            ...
            #jogador 2 escolhe a peça para o jogador 1 jogar
            peca = pecas[jogada(1, pecas)]
            pecas.remove(peca)
            print(f'O computador escolheu a peça {peca}\n')
        ...
        if jogador == 1:
            ...
            x, y = jogada(2, tabuleiro)
            print(f'O computador escolheu a posição {x}, {y}\n')
